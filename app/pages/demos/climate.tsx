...
export default function ClimateDemo() {
  ...
  return (
    <DemoPageTemplate
      ...
      datasetId="climate-demo"
      chartComponent={dashboardContent}
      fallbackData={temperatureTrends}
      columns={[
        { key: 'year', header: locale === 'sr' ? 'Godina' : 'Year', width: 100 },
        { key: 'avgTemp', header: locale === 'sr' ? 'Prosečna Temp (°C)' : 'Avg Temp (°C)', width: 150 },
        { key: 'anomaly', header: locale === 'sr' ? 'Anomalija (°C)' : 'Anomaly (°C)', width: 150 },
        { key: 'extremeEvents', header: locale === 'sr' ? 'Ekstremni događaji' : 'Extreme Events', width: 150 },
      ]}
    />
  );
}
