          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <Box sx={{ p: 3, borderRadius: 3, border: '1px solid', borderColor: 'grey.200', backgroundColor: 'white', boxShadow: '0 10px 25px rgba(0,0,0,0.05)' }}>
                ...
                <ColumnChart
                  data={sectorComposition.map((s) => ({ sector: s.sector, percentage: s.percentage }))}
                  xKey="sector"
                  yKey="percentage"
                  xLabel={locale === 'sr' ? 'Sektor' : 'Sector'}
                  yLabel="%"
                  width={600}
                  height={360}
                  showTooltip
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ p: 3, borderRadius: 3, border: '1px solid', borderColor: 'grey.200', backgroundColor: 'white', boxShadow: '0 10px 25px rgba(0,0,0,0.05)' }}>
                ...
                <ColumnChart
                  data={tradeBalance.map((t) => ({ year: t.year.toString(), exports: t.exports, imports: t.imports }))}
                  xKey="year"
                  yKey="exports"
                  xLabel={locale === 'sr' ? 'Godina' : 'Year'}
                  yLabel={locale === 'sr' ? 'Izvoz (mld €)' : 'Exports (bn €)'}
                  width={600}
                  height={360}
                  colors={['#0ea5e9']}
                  showTooltip
