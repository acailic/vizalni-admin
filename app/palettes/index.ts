...
export const createSequentialInterpolator = (palette: SequentialPaletteType) => {
...
export const createDivergingInterpolator = (palette: DivergingPaletteType) => {
  const palettes: Record<DivergingPaletteType, string[]> = {
...
export const Palette = {
  ...
  getColors: (palette: SequentialPaletteType | DivergingPaletteType, count: number): string[] => {
    const interpolator = palette.includes('rdbu') || palette.includes('rdyl') || palette.includes('spectral')
