...
export const LineChart = memo(({ data, xKey, yKey, width = 800, height = 400, margin = { top: 20, right: 30, bottom: 60, left: 80 }, color = "#4caf50", colors = ["#4caf50", "#2196f3", "#ff9800", "#f44336", "#9c27b0", "#00bcd4"], xLabel = "", yLabel = "", multiSeries = false, showZeroLine = false, }) => {
