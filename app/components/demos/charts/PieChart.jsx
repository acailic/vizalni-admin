...
export const PieChart = memo(({ data, labelKey, valueKey, width = 500, height = 500, colors = [...schemeCategory10], showPercentages = true, }) => {
    ...
    useEffect(() => {
        ...
        // Animate labels
        labels.transition().delay(1000).duration(400).style("opacity", 1);
        // Add legend
        const legend = svg
            .append("g")
